<template>
  <div class="shop_container">
    <ul class="shop_list" v-if="shops.length">
      <!-- <router-link tag="li" :to="{name:'ShopGoods'}" class="shop_li border-1px" v-for="(shop, index) in shops" :key="index"> -->
      <li class="shop_li border-1px" v-for="(shop, index) in shops"
          :key="index" @click="$router.push('/shop')">
        <a>
          <div class="shop_left">
            <img class="shop_img" src="https://source.unsplash.com/random/73x75" />
          </div>
