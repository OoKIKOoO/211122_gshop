    ...
    <nav class="shop-nav" :style="{backgroundImage: `url(${info.bgImg})`}">
      ...
      <div class="shop-header-discounts" v-if="info.supports"> 
        <div class="discounts-left"> 
          <div class="activity activity-green"> 
            <span class="content-tag" :class="activityClasses[info.supports[0].type]"> 
              <span class="mini-tag">{{info.supports[0].name}}</span> 
            </span> 
            <span class="activity-content ellipsis">{{info.supports[0].content}}</span> 
          </div> 
        </div> 
        <div class="discounts-right" @click="toogleActivityShow"> {{info.supports.length}} 个优惠 </div> 
      </div> 
      <!-- 商品卡片 -->
          ...
          <div class="brief-modal-content"> 
            <h2 class="content-title"> 
              ...
              <div class="mask-footer"> 
                <span class="iconfont icon-close"  @click="toogleShopShow"></span> 
              </div> 
            </div> 
      ...
      <div class="activity-sheet" v-show="activityShow"> 
        ...
        <div class="activity-sheet-content" v-show="activityShow"> 
          ...
          <ul class="list"> 
            <li class="activity-item" v-for="(activity,index) in info.supports" :key="index" :class="activityClasses[activity.type]"> 
              <span class="content-tag"> 
                <span class="mini-tag">{{activity.name}}</span> 
              </span> 
              <span class="activity-content">{{activity.content}}</span> 
            </li> 
          </ul> 
          <div class="activity-sheet-close" @click="toogleActivityShow"> 
            <span class="iconfont icon-close"></span> 
          </div> 
        </div> 
        </transition>
        <div class="activity-sheet-cover" v-show="activityShow"></div> 
      </div> 
  </div> 
</template>
