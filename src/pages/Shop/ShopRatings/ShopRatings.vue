    ...
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        <div class="rating-type border-1px"> 
          ...
          <span class="block positive" :class="{active:selectType === 0}" @click="setSelectType(0)"> 满意 {{ratings.filter((rating) => rating.rateType === 0).length}}
            <span class="count"></span> 
          </span> 
          <span class="block negative" :class="{active:selectType === 1}" @click="setSelectType(1)"> 不满意
            <span class="count">{{ratings.filter((rating) => rating.rateType === 1).length}}</span> 
          </span> 
        </div>
        <div class="switch" :class="{on:onlyShowText}"> 
          <span class="iconfont icon-check_circle" @click="toggleType"></span> 
